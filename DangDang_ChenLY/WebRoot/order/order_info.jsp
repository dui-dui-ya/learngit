	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
				<s:iterator value="orderItems" status="sta">
					<tr>
						<td valign="top">
							<s:property value="#sta.index+1"/>
							<%-- 或者<s:property value="#sta.count"/> --%>
						</td>
						<td valign="top">
						...
						<td valign="top">
							...
							<s:property value="book.bookDprice"/>
						</td>
						<td valign="top">
							<s:property value="shopNum"/> 
						</td>
						<td valign="top">
				...
				<tr>
					<td valign="top" class="w1" style="text-align: left" colspan="5">
						￥<b><s:property value="#session.cart.totalPrice"/> </b>
					</td>
				</tr>
			</table>
			<br />
			...
			<div class="login_in">
				...
				<a href="<s:url value='/address/address_findAllAddress'></s:url>"><input id="btnClientRegister" class="button_1" name="submit"
