...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			...
			<p>
				选择地址：
				<form action="<s:url value='/address/address_findAddressById'></s:url>" method="post">
					<select id="address" name="userAddressId">
						<option value="0">
							填写新地址
						</option>
			...
			<s:property value='address.addressId'/>
			<form name="ctl00" method="post" action="${pageContext.request.contextPath}/order/order_addOrder?newAddressId=1" id="f">
				<input type="hidden" name="id" id="addressId" />

				<table class="tab_login">
					<tr>
						<td valign="top" class="w1">
							收件人姓名：<%-- <s:property value='address.addressId'/> --%>
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="fullAddress" class="text_input"
								id="fullAddress" value="<s:property value='address.detailAddress'/>" />
					...
					<tr>
						...
						<td>
							<input type="text" class="text_input" name="postalCode"
								id="postalCode" value="<s:property value='address.zipcode'/>" />
					...
					<tr>
						...
						<td>
							<input type="text" class="text_input" name="phone"
								id="phone" value="<s:property value='address.telphone'/>" />
					...
					<tr>
						...
						<td>
							<input type="text" class="text_input" name="mobile"
								id="mobile" value="<s:property value='address.addrMobile'/>" />
