...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="<s:url value='/user/user_openEmial'></s:url>" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						我们给您：<font color="red"><s:property value="#session.user.userName"/></font></>发送了验证邮件，邮件验证码为：
						<span class="red"><span id="lblEmail">
						
						<s:property value="#session.EMAIL_CODE"/>
						</span>
						</span>
						<span class="t1"> 
						请登录您的邮箱收信。
					...
					<div class="mess">
						...
						<input name="emailNumber" type="text" id="validatecode" class="yzm_text" />
